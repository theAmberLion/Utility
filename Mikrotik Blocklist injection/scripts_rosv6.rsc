...
:local WanIf "WAN-eth1"
:local ScriptOwner "imona"
...
add dont-require-permissions=no name=\
    ...
    \r\
    \n}"
add dont-require-permissions=no name=2_Download_and_parse_blocklist_de_strongIPs \
    owner=$ScriptOwner policy=\
    ...
    \n}"
add dont-require-permissions=no name=1_Download_and_parse_firehol_dshield_org_30d\
    owner=$ScriptOwner policy=\
    ftp,read,write,test source="# Script: update_blocklist_de_strongips_ROSv7 \
...
add disabled=yes interval=1w name=Update_firehol_spamhaus_drop_blocklist on-event=\
    ...
    ftp,read,write,test start-date=feb/16/2026 start-time=05:50:00
add disabled=yes interval=1d name=Update_greensnow_co_blocklist on-event=\
    ...
    ftp,read,write,test start-date=feb/16/2026 start-time=06:00:00
add disabled=yes interval=1d name=Update_firehol_botscout_7d_blocklist on-event=\
    ...
    ftp,read,write,test start-date=feb/16/2026 start-time=06:15:00
add disabled=yes interval=1w name=Update_firehol_php_dictionary_30d_blocklist on-event=\
    ...
    policy=ftp,read,write,test start-date=feb/16/2026 start-time=06:25:00
add disabled=yes interval=1w name=1_Update_firehol_dshield_org_30d_blocklist on-event=\
    "/system/script/run Download_and_parse_firehol_dshield_org_30d" policy=\
    ftp,read,write,test start-date=feb/16/2026 start-time=06:30:00
add disabled=yes interval=1w name=2_Update_blocklist_de_strongIPs_blocklist on-event=\
    "/system/script/run Download_and_parse_blocklist_de_strongIPs" policy=\
    ftp,read,write,test start-date=feb/16/2026 start-time=06:40:00
